  ...
  return (
    <>
      <div className="container-fluid rounded-3 p-3 bg-dark text-white">
        ...
        <p className="text-start">Taxes ({taxPercentage*100}%): ${(subtotal*taxPercentage).toFixed(2)}USD</p>
        <hr />
        <p className="text-start">Total: ${(subtotal + (subtotal * taxPercentage)).toFixed(2)}USD</p>
      </div>
    </>
  )
}